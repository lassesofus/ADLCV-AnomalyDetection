#this is the script where we train our simpel classifier and get the saliency map out
...
def main():
    ...
    #change the model that you choose
    ...
    def forward_backward_log(data_loader, step, prefix="train"):
        ...
        for i, (sub_batch, sub_labels, sub_t) in enumerate(
            ...
            if prefix=="train":
                ...
                output_max.backward()
                saliency, _ = th.max(sub_batch.grad.data.abs(), dim=1) #I should visualize the saliency

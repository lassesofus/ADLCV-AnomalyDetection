...
source ../adlcvproject/bin/activate

python scripts/image_train.py --data_dir data/brats/training --dataset brats $MODEL_FLAGS $DIFFUSION_FLAGS $TRAIN_FLAGS
